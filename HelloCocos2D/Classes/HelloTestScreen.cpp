...
CCScene* HelloTest::scene()
{
    ...
    do 
    {
        ...
        HelloTest *layer = HelloTest::create();
        CC_BREAK_IF(! layer);
...
bool HelloTest::init()
{
    ...
    do 
    {
		...
		for (int i = 0; i < m_nTestCount; ++i)
		{
			...
			//#endif        
			CCMenuItemLabel* pMenuItem = CCMenuItemLabel::create(label, this, menu_selector(HelloTest::menuCallback));

			m_pItmeMenu->addChild(pMenuItem, i + 10000);
			pMenuItem->setPosition( ccp( 240, (160 - (i + 1) * LINE_SPACE) ));
		}
...
void HelloTest::menuCallback(CCObject* pSender)
{
...
void HelloTest::ccTouchesBegan(CCSet *pTouches, CCEvent *pEvent)
{
...
void HelloTest::ccTouchesMoved(CCSet *pTouches, CCEvent *pEvent)
{
	CCSetIterator it = pTouches->begin();
	CCTouch* touch = (CCTouch*)(*it);
