...
void HelloBox2D::menuCallback(CCObject* pSender)
{
...
void HelloBox2D::addNewSpriteAtPosition(CCPoint p)
{
	...
	dynamicBox.SetAsBox(32/PTM_RATIO/2.f, 32/PTM_RATIO/2.f);//These are mid points for our 1m box
...
void HelloBox2D::ccTouchesEnded(CCSet* touches, CCEvent* event)
{
